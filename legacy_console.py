"""Preserved V4 / technical console (kept, not part of the V5 product UI).

P0C replaces the first-level navigation with five business pages
(app.py).  The previous multi-page console — job closure, standalone hazard
ledger, EHS cockpit, toolbox, SDS library, JSA tool and the AI workflow
console — is kept runnable here so the technical capability is not lost:

    streamlit run legacy_console.py

Nothing in this file is exposed to the business navigation of the V5 product.
The V4 regression tests drive this entry point.
"""
